...
def generate_sitemap(app):
    links = []
    for rule in app.url_map.iter_rules():# Filter out rules we can't navigate to in a browser
        if "GET" in rule.methods and has_no_empty_params(rule): # And rules that require parameters
